...
from services.storage.broadcast_repository import BroadcastRepositoryMixin
from services.storage.channel_repository import ChannelRepositoryMixin
...
from services.storage.models import (
    ...
    Group,
    GroupMember,
    MANDATORY_SUBSCRIPTION_TOGGLE_KEY,
    Settings,
    StatsSnapshot,
    User,
)
from services.storage.app_settings_repository import AppSettingsRepositoryMixin
...
class DataBase(
    ...
    BroadcastRepositoryMixin,
    AppSettingsRepositoryMixin,
):
