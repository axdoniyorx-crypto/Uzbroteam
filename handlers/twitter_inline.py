...
async def handle_twitter_inline_query(
    ...
    *,
    ...
    try:
        ...
        action_text = "Rasmni inline yuborish" if media_kind == "photo" else "Videoni inline yuborish"
        prompt_text = (
    ...
    *,
    ...
    async def _plan(request, edit_status, state) -> None:
        ...
        if not context:
            ...
            await edit_status("Faqat bitta rasm yoki bitta video postlari inline rejimda qo'llab-quvvatlanadi.")
            return
