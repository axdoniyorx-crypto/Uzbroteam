...
DEFAULT_COMMAND = [
    "sh",
    "-c",
    "gunicorn --bind 0.0.0.0:${PORT:-8080} --workers 1 --threads 8 --timeout 120 main:flask_app",
]
...
def _ensure_runtime_access(path: Path, *, owner_only: bool) -> None:
    # Use secure permissions: 755 for directories, 644 for files
    access_mode = 0o755 if path.is_dir() else 0o644
    try:
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Set secure umask: 0o022 creates files as 644 and directories as 755
    os.umask(0o022)
