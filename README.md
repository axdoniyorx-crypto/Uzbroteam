...
API_SECRET=
CHANNEL_ID=
# Falls back to COBALT_URL, then to a default public Cobalt instance
# (https://uzbroteam.onrender.com/) if left unset.
COBALT_API_URL=
# Optional — only needed if your Cobalt instance requires an API key.
COBALT_API_KEY=
